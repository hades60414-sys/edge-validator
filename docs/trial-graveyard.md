...
兩份來源報告不公開(私有 repo,內含策略細節),但在此留下檔名與 SHA-256 指紋:
日後(例如面試場合)可出示原檔,任何人當場重算 hash 即可驗證「本文摘錄的來源
在 2026-07 就已存在且未被事後改寫」。

```
FARM_DIAGNOSIS_AND_DEPLOYMENT_2026-07-07.md
sha256 = 257655a5938a733d2b29dd07bfebb1b8e8723b5b22ff7101ea4b85e5b89e40cf

REDTEAM_NEGATIVE_VERDICT_2026-07-07.md
sha256 = 4eede47a78a206b461b8437eee274ec825192f1fb9842c0bcca6796ef82a4c26
```
